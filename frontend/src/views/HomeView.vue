...
<header class="pc">
	...
	<h1 class="logo"><a href="index.html"><img src="../assets/img/logo.png" alt="SAMPLE SITE"></a></h1>
...
<header class="sh">
	...
	<h1 class="logo"><a href="index.html"><img src="../assets/images/logo.png" alt="SAMPLE SITE"></a></h1>
...
export default {
  head: {
    ...
    meta: [
		...
		{ name: 'description', content: 'ここにサイト説明を入れます'},
		{ name: 'keywords', content: 'キーワード１,キーワード２,キーワード３,キーワード４,キーワード５'}
    ],
    link: [
